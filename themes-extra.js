(function installSelectedThemes() {
  ...
  const art = {
    ...
    newspaper: svgBg(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390 844"><defs><pattern id="paper" width="10" height="10" patternUnits="userSpaceOnUse"><path d="M0 9h10M9 0v10" stroke="#2a2823" stroke-opacity=".025" stroke-width=".55"/><circle cx="3" cy="4" r=".45" fill="#2a2823" fill-opacity=".045"/></pattern></defs><rect width="390" height="844" fill="#ecdcbc"/><rect width="390" height="844" fill="url(#paper)"/><path d="M22 34h346M22 39h346M22 134h346M22 139h346M22 760h346M22 767h346" stroke="#2a2823" stroke-opacity=".30"/><path d="M22 32h346" stroke="#b43b30" stroke-opacity=".68" stroke-width="2.2"/><g stroke="#2a2823" stroke-opacity=".11" stroke-width=".8"><path d="M56 160v560M195 160v560M334 160v560"/><path d="M56 204h108M56 248h108M56 292h108M56 336h108M226 204h108M226 248h108M226 292h108M226 336h108M56 430h278M56 474h278M56 518h278M56 562h278"/></g><g fill="#2a2823" fill-opacity=".12"><rect x="58" y="96" width="90" height="7" rx="1"/><rect x="58" y="112" width="138" height="3" rx="1"/><rect x="238" y="96" width="94" height="3" rx="1"/><rect x="238" y="110" width="70" height="3" rx="1"/></g><path d="M52 690h286M52 702h286" stroke="#b43b30" stroke-opacity=".22"/></svg>`),
    newspaperCard: svgBg(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 360 220"><rect width="360" height="220" fill="#f4ead3" fill-opacity=".74"/><path d="M16 26h328M16 31h328" stroke="#b43b30" stroke-opacity=".62" stroke-width="1.2"/><path d="M16 52h328M16 184h328M16 190h328" stroke="#2a2823" stroke-opacity=".22"/><g stroke="#2a2823" stroke-opacity=".12" stroke-width=".75"><path d="M118 64v106M240 64v106"/><path d="M28 78h78M28 100h78M28 122h78M28 144h78M130 78h98M130 100h98M130 122h98M130 144h98M252 78h80M252 100h80M252 122h80M252 144h80"/></g></svg>`),
  ...
  const skins = {
    celadon: {
      screen: {
        backgroundImage: 'linear-gradient(180deg, #e7eee9 0%, #edf4ef 54%, #dfeae4 100%)',
      ...
      poemCard: {
        ...
        backgroundImage: 'linear-gradient(145deg, rgba(255,255,255,.88), rgba(244,250,246,.96))',
        backgroundPosition: 'center', backgroundSize: 'auto', backgroundRepeat: 'no-repeat',
        boxShadow: '0 9px 20px rgba(36,79,70,.13)',
      },
      hero: {
        backgroundImage: 'linear-gradient(145deg, rgba(255,255,255,.84), rgba(244,250,246,.96))',
        backgroundPosition: 'center', backgroundSize: 'auto', backgroundRepeat: 'no-repeat',
      },
      panel: {
      ...
      preview: { backgroundImage: 'linear-gradient(180deg, #e7eee9, #edf4ef)', backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' },
    },
    inkPlum: {
