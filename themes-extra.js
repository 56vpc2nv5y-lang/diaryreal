(function installSelectedThemes() {
  ...
  const skins = {
    ...
    seaSalt: {
      screen: { backgroundImage: `${art.waves}, radial-gradient(circle at 84% 8%, rgba(255,245,207,.88), transparent 22%), linear-gradient(180deg, #dff3f6 0%, #f7fbf8 54%, #d8eef2 100%)`, backgroundPosition: 'center bottom, center, center', backgroundSize: '100% 170px, auto, cover', backgroundRepeat: 'no-repeat' },
      poemCard: {
        borderRadius: 22, border: '1px solid rgba(72,145,168,.24)',
        backgroundImage: `${art.waves}, linear-gradient(155deg, rgba(255,255,255,.98), rgba(244,252,252,.96))`,
        backgroundPosition: 'center bottom, center', backgroundSize: '100% 108px, auto', backgroundRepeat: 'no-repeat',
        boxShadow: '0 12px 28px rgba(54,126,151,.13)',
      },
      hero: { backgroundImage: `${art.waves}, linear-gradient(155deg, rgba(255,255,255,.98), rgba(244,252,252,.96))`, backgroundPosition: 'center bottom, center', backgroundSize: '100% 108px, auto', backgroundRepeat: 'no-repeat' },
      panel: {
        borderRadius: 18, border: '1px solid rgba(72,145,168,.20)',
        backgroundImage: `${art.coastPaper}, linear-gradient(155deg, #fff, #eef9fa)`,
        backgroundPosition: 'center bottom, center', backgroundSize: '100% 84px, auto', backgroundRepeat: 'no-repeat',
        boxShadow: '0 8px 20px rgba(54,126,151,.10)',
      },
      nav: { borderTop: '1px solid rgba(72,145,168,.20)', background: 'rgba(245,252,252,.96)', boxShadow: '0 -5px 18px rgba(54,126,151,.08)' },
      tabItem: { borderRadius: 20, background: 'rgba(255,255,255,.76)', boxShadow: '0 3px 10px rgba(54,126,151,.10)' },
      tabActive: { color: '#246f89' },
      primary: { background: 'linear-gradient(145deg, #69bfd4, #2e7f9d)', borderRadius: 26, boxShadow: '0 7px 18px rgba(46,127,157,.26)' },
      preview: { borderRadius: 18, backgroundImage: `${art.waves}, linear-gradient(180deg, #dff3f6, #f7fbf8)`, backgroundPosition: 'center bottom, center', backgroundSize: '100% 42%, auto', backgroundRepeat: 'no-repeat' },
    },
    obsidianDawn: {
      screen: { backgroundImage: 'radial-gradient(circle at 82% 9%, rgba(255,205,126,.56) 0 4%, rgba(255,220,164,.24) 5% 16%, transparent 32%), linear-gradient(180deg, #fff8eb 0%, #f7efe2 58%, #efe8df 100%)' },
      poemCard: {
        borderRadius: 22, border: '1px solid rgba(177,130,76,.20)',
        backgroundImage: 'radial-gradient(circle at 86% 12%, rgba(255,205,126,.48) 0 3%, rgba(255,222,173,.20) 4% 18%, transparent 31%), linear-gradient(150deg, #fffdf8, #fbf2e4)',
        boxShadow: '0 12px 28px rgba(132,91,48,.12)',
      },
      hero: { backgroundImage: 'radial-gradient(circle at 86% 12%, rgba(255,205,126,.48) 0 3%, rgba(255,222,173,.20) 4% 18%, transparent 31%), linear-gradient(150deg, #fffdf8, #fbf2e4)' },
      panel: {
        borderRadius: 18, border: '1px solid rgba(177,130,76,.18)',
        backgroundImage: 'radial-gradient(circle at 90% 14%, rgba(255,205,126,.30), transparent 28%), linear-gradient(150deg, #fffdf8, #f8efe3)',
        boxShadow: '0 8px 20px rgba(132,91,48,.09)',
      },
      nav: { borderTop: '1px solid rgba(177,130,76,.18)', background: 'rgba(255,249,239,.96)', boxShadow: '0 -5px 18px rgba(132,91,48,.07)' },
      tabItem: { borderRadius: 18, background: 'rgba(255,255,255,.58)', boxShadow: 'none' },
      tabActive: { color: '#9d642d' },
      primary: { borderRadius: 24, background: 'linear-gradient(145deg, #e5ad61, #b77734)', boxShadow: '0 7px 17px rgba(183,119,52,.24)' },
