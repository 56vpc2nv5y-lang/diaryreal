(function installSelectedThemes() {
  ...
  const generated = {
    ...
    quietNewsprint: imgBg('assets/themes/generated/quiet-newsprint-r72.png'),
    softMint: imgBg('assets/themes/generated/soft-mint-paper-r72.png'),
  };
  const art = {
    ...
    duskPaper: svgBg(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 390 844" preserveAspectRatio="none"><defs><radialGradient id="glow" cx="54%" cy="36%" r="72%"><stop offset="0" stop-color="#fffaf4" stop-opacity=".80"/><stop offset=".58" stop-color="#eee7f0" stop-opacity=".46"/><stop offset="1" stop-color="#cfc4d8" stop-opacity=".52"/></radialGradient><pattern id="fiber" width="17" height="17" patternUnits="userSpaceOnUse"><path d="M0 16h17M16 0v17" stroke="#6e6278" stroke-opacity=".026" stroke-width=".7"/><path d="M3 10c4-2 7 2 11-1" fill="none" stroke="#6e6278" stroke-opacity=".035" stroke-width=".6"/></pattern></defs><rect width="390" height="844" fill="#e8e3ed"/><rect width="390" height="844" fill="url(#glow)"/><rect width="390" height="844" fill="url(#fiber)"/><path d="M-18 122c62-30 116 16 186-8 72-25 129 16 240-20" fill="none" stroke="#8a789b" stroke-opacity=".10" stroke-width="18"/><path d="M-24 692c76-36 142 14 218-10 78-25 132 20 220-15" fill="none" stroke="#b6a6bf" stroke-opacity=".14" stroke-width="26"/><path d="M50 112h286M74 730h240" stroke="#6b5f75" stroke-opacity=".08"/></svg>`),
  ...
  const skins = {
    ...
    dusk: {
      ...
      poemCard: {
        borderRadius: 16, border: '1px solid rgba(66,48,82,.12)',
        backgroundImage: `linear-gradient(150deg, rgba(255,253,251,.84), rgba(246,241,248,.88)), ${art.duskPaper}`,
        backgroundPosition: 'center, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat',
        boxShadow: '0 8px 22px rgba(66,48,82,.08)',
      },
      hero: { backgroundImage: `linear-gradient(150deg, rgba(255,253,251,.84), rgba(246,241,248,.88)), ${art.duskPaper}`, backgroundPosition: 'center, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat' },
      panel: {
        borderRadius: 16, border: '1px solid rgba(66,48,82,.10)',
        backgroundImage: `linear-gradient(150deg, rgba(255,253,251,.84), rgba(244,239,247,.90)), ${art.duskPaper}`,
        backgroundPosition: 'center, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat',
        boxShadow: '0 6px 18px rgba(66,48,82,.06)',
      },
      nav: { borderTop: '1px solid rgba(66,48,82,.18)', background: 'rgba(246,241,248,.92)', boxShadow: '0 -4px 16px rgba(66,48,82,.05)' },
      tabItem: { borderRadius: 16, background: 'rgba(255,255,255,.44)', boxShadow: '0 2px 8px rgba(66,48,82,.04)' },
      tabActive: { color: '#655374' },
      primary: { background: 'linear-gradient(145deg, #9b7eaa, #6b5a7a)', borderRadius: 22, boxShadow: '0 7px 16px rgba(107,90,122,.18)' },
      preview: { borderRadius: 16, backgroundImage: `linear-gradient(180deg, rgba(255,252,247,.24), rgba(218,207,226,.24)), ${art.duskPaper}`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' },
    },
    morningPaper: {
      screen: { backgroundImage: `linear-gradient(180deg, rgba(255,249,236,.30), rgba(225,201,159,.16)), ${generated.quietNewsprint}`, backgroundPosition: 'center, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat' },
      poemCard: {
        borderRadius: 3, border: '1px solid rgba(42,40,35,.34)',
        backgroundImage: `linear-gradient(180deg, rgba(255,249,236,.88), rgba(242,231,205,.88)), ${generated.quietNewsprint}`,
        backgroundPosition: 'center, center',
        backgroundSize: 'cover, cover',
        backgroundRepeat: 'no-repeat',
        boxShadow: 'inset 0 4px 0 -2px rgba(180,59,48,.62), inset 0 -2px 0 -1px rgba(42,40,35,.34), 0 8px 18px rgba(42,40,35,.08)',
      },
      hero: { backgroundImage: `linear-gradient(180deg, rgba(255,249,236,.88), rgba(242,231,205,.88)), ${generated.quietNewsprint}`, backgroundPosition: 'center, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat', boxShadow: 'inset 0 4px 0 -2px rgba(180,59,48,.58)' },
      panel: {
        borderRadius: 3, border: '1px solid rgba(42,40,35,.26)',
        backgroundImage: `linear-gradient(180deg, rgba(255,249,236,.90), rgba(238,226,198,.88)), ${generated.quietNewsprint}`,
        backgroundPosition: 'center, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat',
        boxShadow: 'inset 0 4px 0 -2px rgba(180,59,48,.48)',
      },
      nav: { borderTop: '1px solid rgba(42,40,35,.46)', background: 'rgba(244,234,211,.97)', paddingLeft: 20, paddingRight: 20 },
      tabItem: { borderRadius: 2, border: '1px solid rgba(42,40,35,.14)', background: 'rgba(255,249,236,.38)' },
      ...
      preview: { borderRadius: 3, backgroundImage: `linear-gradient(180deg, rgba(255,249,236,.26), rgba(225,201,159,.14)), ${generated.quietNewsprint}`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', boxShadow: 'inset 0 4px 0 -2px rgba(180,59,48,.60)' },
    },
    seaSalt: {
      screen: {
    ...
    mintNote: {
      screen: {
        backgroundImage: `linear-gradient(180deg, rgba(247,251,246,.46), rgba(215,232,224,.30)), ${generated.softMint}`,
        backgroundPosition: 'center, center',
        backgroundSize: 'cover, cover',
        backgroundRepeat: 'no-repeat',
      },
      poemCard: {
        borderRadius: 18,
        border: '1px solid rgba(63,118,104,.20)',
        backgroundImage: `linear-gradient(155deg, rgba(255,255,250,.90), rgba(241,247,241,.92)), ${generated.softMint}`,
        backgroundPosition: 'center, center',
        backgroundSize: 'cover, cover',
        backgroundRepeat: 'no-repeat',
        boxShadow: '0 10px 24px rgba(47,96,83,.10)',
      },
      hero: { backgroundImage: `linear-gradient(155deg, rgba(255,255,250,.90), rgba(241,247,241,.92)), ${generated.softMint}`, backgroundPosition: 'center, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat' },
      panel: {
        borderRadius: 16,
        border: '1px solid rgba(63,118,104,.18)',
        backgroundImage: `linear-gradient(155deg, rgba(255,255,250,.88), rgba(240,247,241,.92)), ${generated.softMint}`,
        backgroundPosition: 'center, center',
        backgroundSize: 'cover, cover',
        backgroundRepeat: 'no-repeat',
        boxShadow: '0 7px 18px rgba(47,96,83,.07)',
      },
      nav: { borderTop: '1px solid rgba(63,118,104,.20)', background: 'rgba(238,247,240,.95)', boxShadow: '0 -5px 18px rgba(47,96,83,.06)' },
      tabItem: { borderRadius: 18, background: 'rgba(255,255,250,.56)', boxShadow: '0 2px 8px rgba(47,96,83,.06)' },
      tabActive: { color: '#2f7567' },
      primary: { background: 'linear-gradient(145deg, #4b8b7d, #2f7567)', borderRadius: 22, boxShadow: '0 7px 17px rgba(47,117,103,.20)' },
      preview: { borderRadius: 18, backgroundImage: `linear-gradient(180deg, rgba(247,251,246,.42), rgba(215,232,224,.22)), ${generated.softMint}`, backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' },
    },
    gardenia: {
  ...
  window.THEMES.mintNote = makeTheme(window.THEMES.celadon, {
    key: 'mintNote',
    name: '青笺',
    description: '浅青纸纹，松绿控件',
    fontSerif: fonts.writing,
    fontWriting: fonts.writing,
    fontBody: fonts.song,
    fontCanvas: fonts.writing,
    writingSpacing: '0.085em',
    writingLineHeight: 2.02,
    palette: {
      bg: '#dce9e2',
      paper: '#f6f8f2',
      card: '#fbfbf6',
