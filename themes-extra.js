(function installSelectedThemes() {
  ...
  const skins = {
    ...
    morningPaper: {
      screen: { backgroundImage: `${art.magazine}, linear-gradient(180deg, #efe2c7, #e6d5b6)`, backgroundPosition: 'center top, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat' },
      poemCard: {
        borderRadius: 2, border: '1px solid rgba(42,40,35,.48)',
        backgroundImage: `${art.magazineCard}, linear-gradient(180deg, rgba(255,249,236,.97), rgba(242,231,205,.96))`,
      ...
      hero: { backgroundImage: `${art.magazineCard}, linear-gradient(180deg, rgba(255,249,236,.97), rgba(242,231,205,.96))`, backgroundPosition: 'center top, center', backgroundSize: '100% 150px, cover', backgroundRepeat: 'no-repeat', boxShadow: 'inset 0 5px 0 -2px #b43b30' },
      panel: {
        borderRadius: 2, border: '1px solid rgba(42,40,35,.34)',
        backgroundImage: `${art.magazineCard}, linear-gradient(180deg, rgba(255,249,236,.92), rgba(238,226,198,.94))`,
      ...
      preview: { borderRadius: 2, backgroundImage: `${art.magazine}, linear-gradient(180deg, #efe2c7, #e6d5b6)`, backgroundPosition: 'center top, center', backgroundSize: 'cover, cover', backgroundRepeat: 'no-repeat', boxShadow: 'inset 0 5px 0 -2px #b43b30' },
    },
    seaSalt: {
